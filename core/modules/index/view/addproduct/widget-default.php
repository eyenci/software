...
<div class="box box-solid box-primary">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="text" name="name" class="form-control" required id="name" autofocus="" placeholder="Nombre del Producto">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="text" name="price_out" class="form-control " required id="price_out" placeholder="Precio de venta">
    </div>
  </div>
  <div class="form-group">
...
<p class="alert alert-info">* Campos obligatorios: Nombre, Precio, Categoria</p>
