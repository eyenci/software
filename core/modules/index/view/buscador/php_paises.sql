...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2018 a las 00:13:43
...
`id_pais` int(11) NOT NULL,
  ...
  `nombre_pais` varchar(120) DEFAULT NULL
...
INSERT INTO `lista_paises` (`id_pais`, `iso`, `nombre_pais`) VALUES
(1, 'AF', 'Afganistán'),
(2, 'AX', 'Islas Gland'),
(3, 'AL', 'Albania'),
(4, 'DE', 'Alemania'),
