...
<section class="content-header">
    <h1><?php echo $sell->id ?> <small>Unir Mesa</small></h1>
</section>
...
<div class="row">
  ...
  <?php setcookie("prdupd","",time()-18600); endif; ?>
		<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=updatenumeromesa" role="form">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Id_Mesa</label> 
    <div class="col-md-6">
      <input type="text" name="id" class="form-control" id="id" value="<?php echo $sell->id; ?>" placeholder="Codigo del Producto" >
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Numero de mesa</label>
    <div class="col-md-6">
      <input type="text" name="item_id" class="form-control" id="item_id" value="<?php echo $sell->item_id; ?>" placeholder="Nombre del Producto" readonly>
    </div>
  </div>
